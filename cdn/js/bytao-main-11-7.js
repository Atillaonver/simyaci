(function ($) {
	...
	-------------------------------------------------------------------------------*/
		if($(this).scrollTop() > 100) {
            $('header.header_area').addClass('navbar_fix')
    }else{
    ...
    function navbarFixed() {
        if ($(".header_area").length) {
            $(window).scroll(function () {
                ...
                if (scroll) {
                    $(".header_area").addClass("navbar_fixed").removeClass("navbar_fix");
                } else {
                    $(".header_area").removeClass("navbar_fixed").addClass("navbar_fix");
                }
            });
        }
    }
...
//            });
  ...
  $(document).on("click","a.no-link,.no-link > a", function (e, slick) {
        e.preventDefault();
    		return false;
    });
    /*---------------navbar js ---------------*/
