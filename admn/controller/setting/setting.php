...
class Setting extends \Opencart\System\Engine\Controller {
	public function index(): void {
		...
		$data['config_path'] = $this->config->get('config_path')?$this->config->get('config_path'):'';
		$data['config_fax'] = $this->config->get('config_fax')?$this->config->get('config_fax'):'';
		$data['config_gsm'] = $this->config->get('config_gsm')?$this->config->get('config_gsm'):'';
		$data['config_date_added'] = date($this->language->get('date_format_short'), strtotime($this->config->get('date_added')));
		...
		$data['config_default_country_id'] = $this->config->get('config_default_country_id');
		...
		$data['config_wholesale_admin'] = $this->config->get('config_wholesale_admin');
		$data['config_footer_column'] = $this->config->get('config_footer_column');
		$data['config_store_languages'] = $this->config->get('config_store_languages');
		$data['config_store_type'] = $this->config->get('config_store_type');
		$data['config_store_currencies'] = $this->config->get('config_store_currencies');
		$data['config_store_user_group_id'] = $this->config->get('config_store_user_group_id');
		
		$this->load->model('user/user_group');

		$data['user_groups'] = $this->model_user_user_group->getUserGroups();
		$data['config_user_group_id'] = $this->config->get('config_user_group_id');
		$data['config_order_key'] = $this->config->get('config_order_key');
		$data['config_url_out'] = $this->config->get('config_url_out');
		$data['config_logo_negative'] = $this->config->get('config_logo_negative');
		
		if (is_file(DIR_IMAGE . html_entity_decode($data['config_logo_negative'], ENT_QUOTES, 'UTF-8'))) {
			$data['logo_negative'] = $this->model_tool_image->resize(html_entity_decode($data['config_logo_negative'], ENT_QUOTES, 'UTF-8'), 100, 100);
		} else {
		...
		$data['config_header_image'] = $this->config->get('config_header_image');
		...
		$data['config_footer_image'] = $this->config->get('config_footer_image');
		...
		$data['config_fligram_image'] = $this->config->get('config_fligram_image');
		...
		$data['config_run_store_as'] = $this->config->get('config_run_store_as')?$this->config->get('config_run_store_as'):0;
		$data['config_runer_store_as'] = $this->config->get('config_runer_store_as')?$this->config->get('config_runer_store_as'):0;
		...
		$data['config_cart_reward'] = $this->config->get('config_cart_reward');
		$data['config_cart_voucher'] = $this->config->get('config_cart_voucher');
		$data['config_cart_shipping'] = $this->config->get('config_cart_shipping');
		$data['config_cart_coupon'] = $this->config->get('config_cart_coupon');
		...
		if ($this->config->get('config_image_topic_height')) {
			...
			$data['config_image_topic_height'] = 100;
		}
		...
		if ($this->config->get('config_image_article_height')) {
			...
			$data['config_image_article_height'] = 100;
		}
		...
		if ($this->config->has('config_mail_mailgun_api')) {
			$data['config_mail_mailgun_api'] = $this->config->get('config_mail_mailgun_api');
		} else {
	...
	public function save(): void {
		...
		if (!$json) {
            ...
            //$this->log->write('POST ARRAY:'.print_r($this->request->post,TRUE));
