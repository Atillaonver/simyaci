	...
	public function indat():void {
		...
		else
		{
			if ($this->request->server['REQUEST_METHOD'] == 'POST') {
				$this->getML('M');
				$this->request->post['language_id'] = $this->request->get['lid'];
				//$this->request->post['row_id'] = $this->request->get['rwid'];
				$json['title'] =$this->request->post['title_item'];
				$json['item_id'] = $this->model->{$this->getFunc('edit')}($this->request->post);
			}
