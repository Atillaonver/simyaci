...
class Home extends \Opencart\System\Engine\Controller {
	...
	protected function getForm() {
		...
		$data['banners'] = [];//$this->model_bytao_banner->getBanners();
		
		//$this->load->model('bytao/media');
		$data['medias'] = [];//$this->model_bytao_media->getMedias();
		
		//$this->load->model('bytao/menu');
		$data['menus'] = [];//$this->model_bytao_menu->getMenus();
		
		//$this->load->model('bytao/custom');
		
		$data['customs'] = [];//$this->model_bytao_custom->getCustoms();
