...
class Store extends \Opencart\System\Engine\Controller {
	...
	public function settingstore():void {
		...
		$setting_info = $this->model_setting_setting->getSetting('config', 0);
		
		
		unset($store_info['config_url']);
		$merge_info = array_merge($setting_info,$store_info);
		$json['Merged'] = $merge_info;
		
		//$this->model_setting_setting->editSetting('config', $merge_info);
