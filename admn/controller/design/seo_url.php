...
class SeoUrl extends \Opencart\System\Engine\Controller {
	...
	public function save(): void {
		$this->load->language('design/seo_url');
		$storeId = isset($this->session->data['store_id'])?(int)$this->session->data['store_id']:0;
		...
		$seo_url_info = $this->model_design_seo_url->getSeoUrlByKeyValue($this->request->post['key'], $this->request->post['value'], $storeId, $this->request->post['language_id']);
		...
		$seo_url_info = $this->model_design_seo_url->getSeoUrlByKeyword($this->request->post['keyword'], $storeId);
		...
		if (!$json) {
			if (!$this->request->post['seo_url_id']) {
				$json['seo_url_id'] = $this->model_design_seo_url->addSeoUrl($this->request->post['key'], $this->request->post['value'], $this->request->post['keyword'], $storeId, $this->request->post['language_id'], $this->request->post['sort_order'],$this->request->post['title'], $this->request->post['route']);
			} else {
				$this->model_design_seo_url->editSeoUrl($this->request->post['seo_url_id'], $this->request->post['key'], $this->request->post['value'], $this->request->post['keyword'], $this->request->post['language_id'], $this->request->post['sort_order'], $this->request->post['title'], $this->request->post['route']);
			}
