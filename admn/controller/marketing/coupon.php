...
class Coupon extends \Opencart\System\Engine\Controller {
	...
	protected function getList(): string {
		...
		foreach ($results as $result) {
			$data['coupons'][] = [
				...
				'code'       	=> $result['code'],
				'type'       	=> $result['type'],
				'type_customer'	=> $result['type_customer'],
		...
		$data['sort_type_customer'] = $this->url->link('marketing/coupon.list', 'user_token=' . $this->session->data['user_token'] . '&sort=type_customer' . $url);
	...
	public function form(): void {
		...
		if (!empty($coupon_info)) {
			$data['type_customer'] = $coupon_info['type_customer'];
		} else {
