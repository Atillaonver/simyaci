...
class Forgotten extends \Opencart\System\Engine\Controller {
	...
	public function confirm(): void {
		...
		if (!$json) {
			$tok = oc_token(40);
			$this->model_user_user->editCode($this->request->post['email'],$tok );

			$this->session->data['success'] = $this->language->get('text_success').' -- '.$tok;
	...
	public function password(): void {
		...
		if (!$json) {
			...
			//$this->model_user_user->editPassword(1, $this->request->post['password']);
