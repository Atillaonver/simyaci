...
class Pdf extends \Opencart\System\Engine\Model {
	...
	public function editPdf(){
		...
		$this->model_setting_setting->editSetting('module_pdf_invoice', $this->request->post,$store_id);
	}
	...
	*/
	...
	public function install(){
		...
		$this->model_setting_setting->editSetting('module_pdf_invoice', $data,$store_id);
