...
class Voucher extends \Opencart\System\Engine\Model {
	...
	public function getTotalVouchers(): int {
		...
		$query = $this->db->query("SELECT COUNT(*) AS `total` FROM `" . DB_PREFIX . "voucher` WHERE `store_id` = '" . (int)$store_id . "'");
