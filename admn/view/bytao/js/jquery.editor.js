jQuery.fn.extend({
    ...
    edit: function () {
		...
		$(eContainer).addClass("editor-container");
		
		var ehead = document.createElement('div');
		$(ehead).addClass("editor-head");
		
		var ebody = document.createElement('div');
		$(ebody).addClass("editor-body");
		var efoot = document.createElement('div');
		$(efoot).addClass("editor-foot");
		
		$(eContainer).append(ehead);
		$(eContainer).append(ebody);
		$(eContainer).append(efoot);
		
		
		
		
		$(this).hide();
		$(this).after(eContainer)
		function Init() {
