...
class Campaign extends \Opencart\System\Engine\Controller {
	public function index(): string {
		if ($this->config->get('total_campaign_status')) {
			$this->load->language('extension/bytao/total/localtax');

			$data['save'] = $this->url->link('extension/opencart/total/campaign.save', 'language=' . $this->config->get('config_language'), true);
			...
			return $this->load->view('extension/bytao/total/campaign', $data);
		}
