...
class PayPal extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/opencart/payment/paypal', 'user_token=' . $this->session->data['user_token'], true)
		);
		...
		$data['partner_url'] = str_replace('&amp;', '%26', $this->url->link('extension/opencart/payment/paypal', 'user_token=' . $this->session->data['user_token'], true));
		$data['callback_url'] = str_replace('&amp;', '&', $this->url->link('extension/opencart/payment/paypal/callback', 'user_token=' . $this->session->data['user_token'], true));
		$data['configure_smart_button_url'] = $this->url->link('extension/opencart/payment/paypal/configureSmartButton', 'user_token=' . $this->session->data['user_token'], true);
	...
	public function configureSmartButton() {
		$this->load->model('extension/opencart/payment/paypal');
