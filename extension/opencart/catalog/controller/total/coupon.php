...
class Coupon extends \Opencart\System\Engine\Controller {
	public function index(): string {
		if ($this->config->get('total_coupon_status')) {
			...
			return $this->config->get('config_cart_coupon')?$this->load->view('extension/opencart/total/coupon', $data):'';
		}
	...
	public function save(): void {
		...
		if ($coupon) {
			...
			$coupon_info = $this->model_marketing_coupon->getCouponByCode($coupon);
