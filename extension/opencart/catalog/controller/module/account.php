...
class Account extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$data['appointment'] = $this->url->link('bytao/appointment', 'language=' . $this->config->get('config_language') . (isset($this->session->data['customer_token']) ? '&customer_token=' . $this->session->data['customer_token'] : ''));
