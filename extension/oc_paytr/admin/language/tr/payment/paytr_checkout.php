...
$_['text_paytr_checkout']                               = '<a href="https://www.paytr.com/" target="_blank"><img src="/extension/oc_paytr/admin/view/image/payment/paytr-logo.svg" width="100" alt="PayTR" title="PayTr"/></a>';
...
$_['text_iframe_v1']                                    = 'Eski Versiyon (v1)';
$_['text_iframe_v2']                                    = 'Yeni Versiyon (v2)';
$_['text_iframe_theme_light']                           = 'Açık Tema';
$_['text_iframe_theme_dark']                            = 'Koyu Tema';

// Entry
$_['entry_title']                                       = 'Başlık';
$_['entry_test_mode']                                   = 'Test Modu';
$_['entry_test_mode_on']                                = 'Test';
$_['entry_test_mode_off']                               = 'Kapalı';
...
$_['entry_iframe_version']                              = 'iFrame Versiyon';
$_['entry_iframe_theme']                                = 'iFrame Tema (Sadece v2 için geçerlidir)';
...
$_['error_paytr_checkout_title']                        = '<strong>Başlık</strong> girilmesi zorunludur!';
$_['error_paytr_checkout_test_mode']                    = '<strong>Test Modu</strong> seçilmesi zorunludur!';
$_['error_paytr_checkout_description']                  = '<strong>Açıklama</strong> girilmesi zorunludur!';
...
$_['error_samesite']                                    = 'DİKKAT: PayTR iFrame API düzgün çalışması için "SameSite Cookie" ayarının <b>Lax</b> olması gerekmektedir! Lütfen <a href="%s">Mağaza Ayarları > Sunucu Sekmesi</a>\'nde bu ayarı düzeltin.';
$_['error_phone']                                       = 'DİKKAT: PayTR iFrame API düzgün çalışması için Telefonun aktif olması gerekmektedir!';
$_['error_phone']                                       = 'DİKKAT: PayTR iFrame API düzgün çalışması için Adresin aktif olması gerekmektedir!';