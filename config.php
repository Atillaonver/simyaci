...
{ // Local
	...
	define('URL_SERVER', 'http://localhost/ADM25/');
...
{ //Live
    ...
    define('URL_SERVER', 'https://simyaci.tr/');
    define('DIR_STORAGE', DIR_PUBLIC.'bystorage/');
    define('DIR_OPENCART', DIR_PUBLIC.'simyaci.tr/public_html/');
    define('DIR_SYSTEM', DIR_PUBLIC . 'bysystem/');
    define('DIR_CLIENT', DIR_PUBLIC.'simyaci.tr/public_html/');
...
define('DIR_ADMIMAGE', DIR_OPENCART.MEDIA);
...
define('DIR_IMAGE', DIR_CLIENT . MEDIA);
