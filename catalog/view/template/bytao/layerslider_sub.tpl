...
<section id="home" class="padbot0">
		...
		<div class="layerslider bannercontainer banner-<?php echo trim($class);?>" style="padding: <?php echo $sliderParams['padding'];?>;">
					<div id="sliderlayer<?php echo $randID; ?>" class="rev_slider <?php echo trim($class);?>banner" style="width:100%;height:<?php echo $sliderParams['height'];?>px; " >
						...
						<ul>
								...
								<div class="caption fade fullscreenvideo" data-autoplay="true" data-x="0" data-y="0" data-speed="500" data-start="10" data-easing="easeOutBack">
									<iframe src="<?php echo $vurl;?>?title=0&amp;byline=0&amp;portrait=0;api=1" width="100%" height="100%"></iframe>
								</div>
										...
										<?php
										 ...
										 foreach ( $slider['layersparams']->layers as $i => $layer )  {
											...
											$endeffect = '';
											if( isset($layer['layer_endanimation']) && $layer['layer_endanimation'] == 'auto' ){
												$layer['layer_endanimation'] = '' ;
											}
											if( isset($layer['layer_endtime']) && (int)$layer['layer_endtime'] ){
										...
										<div class="caption <?php echo $layer['layer_class']; ?> <?php echo isset($layer['layer_animation'])?$layer['layer_animation']:'';?> 
											<?php echo isset($layer['layer_easing'])?$layer['layer_easing']:'';?>
											<?php echo $layer['layer_endanimation'];?>"
											 data-x="<?php echo $layer['layer_left']; ?>"
											 data-y="<?php echo $layer['layer_top']; ?>"
											 <?php echo $layer['layer_link_status']?'data-link ="'.$layer['layer_link'].'"':''; ?>
											 data-speed="300"
											 data-start="<?php echo isset($layer['time_start'])?$layer['time_start']:0; ?>"
											 data-easing="easeOutExpo" <?php echo $endeffect;?> >
											 	<?php if( $type=='image') { ?> 
											 	
											 	<img src="<?php echo HTTP_IMAGE.$layer['layer_image'];?>" alt="" class="byta" />
