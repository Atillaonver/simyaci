...
class Cart extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			$data['cart_reward'] = $this->config->get('config_cart_reward');
			$data['cart_voucher'] = $this->config->get('config_cart_voucher');
			$data['cart_cargo'] = $this->config->get('config_cart_shipping');
			$data['cart_coupon'] = $this->config->get('config_cart_coupon');
