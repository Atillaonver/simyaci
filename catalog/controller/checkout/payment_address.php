...
class PaymentAddress extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$data['addresses'] = $this->load->controller('checkout/cart.addresses',$addresses,'payment',$data['address_id']);
		...
		$data['default_country_id'] =  $this->config->get('config_default_country_id');
