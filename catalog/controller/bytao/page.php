...
class Page extends \Opencart\System\Engine\Controller {
	...
	public function index():void {
		...
		if ($item_info) {
			...
			$data['himage'] = !$item_info['himage']?(!$this->config->get('config_header_image')?by_move($this->config->get('config_header_image')):''):by_move($item_info['himage']);
			$data['fimage'] = !$item_info['fimage']?(!$this->config->get('config_footer_image')?by_move($this->config->get('config_footer_image')):''):by_move($item_info['fimage']);
