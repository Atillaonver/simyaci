...
// Entry
$_['entry_name']     = 'Adınız(Gerekli)';
$_['entry_email']    = 'E-Posta (Gerekli)';
$_['entry_enquiry']  = 'Mesajınız (Gerekli)';
$_['entry_subject']  = 'Konu';


// Email
$_['email_subject']  = '%s Mesaj Gönderdi: %s';

// Errors
$_['error_captcha']  = 'Sen Nasıl İnsansın:%s score:%s !';
